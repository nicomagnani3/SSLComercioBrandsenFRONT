                      ...
                      <div class="info">
                        <div class="product-details">
                          <div class="row justify-content-md-center">
                            <b-col md="6">
                              <b-card-img thumbnail fluid alt="Responsive image"
                                style="max-height: 130px; object-fit: contain" :src="this.imagen[0] == null
                            ...
                            <div class="col-md-4 product-detail">
                              ...
                              <div class="product-info">
                                <div>
                                  <div v-if="Number(this.publicacion.precio) >
                                    Number(0)
                                    ">
                                    <b>Precio: </b>{{
      ...
      <div v-if="this.contrato.length > 0">
        <b-card no-body class="mb-3 p-0"
          ...
          <b-container class="pb-3">
            <b-table show-empty small responsive :items="this.contrato" :fields="fields"
            ...
            <b-alert v-if="verificarVencimiento()" show variant="danger">Atencion: su contrato se encuentra vencido, no
              podra realizar la
              publicacion
              <a href="renovarContrato" class="alert-link">presione aqui para renovarlo</a></b-alert>
            <b-alert v-if="verificarCantPublicaciones()" show variant="danger">Atencion: Usted llego al limite de
              publicaciones, no podra
              realizar la publicacion
              <a href="renovarContrato" class="alert-link">presione aqui para renovarlo y comprar nuevas
                publicaciones</a></b-alert>
          </b-container>
        </b-card>
      </div>
    </div>
