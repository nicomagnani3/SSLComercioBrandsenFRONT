<template>
  <div>
    ...
    <div class="container">
      <div class="bg_main"><img src="@/assets/presentacion/bg-main.png" /></div>
    </div>
    ...
    <div class="about_section layout_padding">
      <div class="container">
        ...
        <div class="about_bg">
          <img src="@/assets/presentacion/about-bg.png" />
        </div>
        <p class="lorem_text">
        ...
        <div class="service_section_2">
          <div class="row">
            <div class="col-sm-12 col-lg-4">
              <div class="icon_1">
                <img src="@/assets/presentacion/icon-1.png" />
              </div>
            ...
            <div class="col-sm-12 col-lg-4">
              <div class="icon_1">
                <img src="@/assets/presentacion/icon-2.png" />
              </div>
            ...
            <div class="col-sm-12 col-lg-4">
              <div class="icon_1">
                <img src="@/assets/presentacion/icon-3.png" />
              </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="contact_bg">
              <img src="@/assets/presentacion/contact-bg.png" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="client_section layout_padding">
      <div class="container">
        ...
        <div class="client_section_2 layout_padding">
          ...
          <div class="icon_4">
            <img src="@/assets/presentacion/icon-4.png" />
          </div>
        </div>
      </div>
    </div>
...
.banner_section{
     width: 100%;
     float: left;
/*      background-image: url(@/assets/presentacion/banner-bg.png);
 */     
 background-image: url(../../assets/presentacion/banner-bg.png);
 height: auto;
     padding-bottom: 90px;
...
.footer_section{
 ...
 background-image: url(../../assets/presentacion/footer-bg.png);
     height: auto;
     padding-bottom: 50px;
     margin-top: 90px;
}
